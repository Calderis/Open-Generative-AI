...
export function SettingsModal(onClose) {
    ...
    apiPanel.innerHTML = `
        <div style="display:flex;flex-direction:column;gap:0.75rem;">
            <div>
                <label style="display:block;font-size:0.75rem;color:rgba(255,255,255,0.5);margin-bottom:0.4rem;font-weight:600;">Replicate API Key</label>
                <input id="settings-api-key" type="password"
                    ...
                    value="${localStorage.getItem('replicate_key') || ''}">
            </div>
            <p style="font-size:0.7rem;color:rgba(255,255,255,0.3);margin:0;">
                Your API key is stored locally and never sent anywhere except api.replicate.com.
            </p>
