...
export function LipSyncStudio() {
    ...
    videoFileInput.onchange = async (e) => {
        ...
        showVideoSpinner();
        try {
            uploadedVideoUrl = await replicate.uploadFile(file);
    ...
    audioFileInput.onchange = async (e) => {
        ...
        showAudioSpinner();
        try {
            uploadedAudioUrl = await replicate.uploadFile(file);
    ...
    generateBtn.onclick = async () => {
        ...
        try {
            ...
            const res = await replicate.processLipSync(lipsyncParams);
