      ...
      <div className="w-full max-w-sm bg-[#0a0a0a]/40 backdrop-blur-xl border border-white/10 rounded-xl p-10 shadow-2xl">
        <div className="flex flex-col items-center text-center mb-10">
          ...
          <p className="text-white/40 text-[13px] leading-relaxed px-4">
            Enter your <a href="https://replicate.com/account/api-tokens" target="_blank" rel="noreferrer" className="text-[#d9ff00] hover:text-[#e5ff33] transition-colors">Replicate.com</a> API key to start creating
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <p className="text-center text-[12px] text-white/20 pt-2">
            Need a key?{' '}
            <a href="https://replicate.com/account/api-tokens" target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#d9ff00] transition-colors font-medium">
              Get one free →
            </a>
          </p>
        </form>
